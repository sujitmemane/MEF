        ...
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5 ">
          <div className="max-w-xl mb-6">
            ...
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              ...
              <span className="text-sm text-gray-900 font-extrathin ">
                Pune-Aurangabad-Hingoli-Akola-Mumbai
              </span>
            </h2>
            <p className="text-base font-thin md:text-lg">
              Join MEF and skyrocket your professional journey. All types of
              ITI, Diploma, Degree and Management courses
            </p>
          </div>
